...
class _FAQPageState extends State<FAQPage> {
  final List<Map<String, String>> faqs = [
    ...
    {
      'question': '수면 데이터가 보이지 않아요(“수면 데이터가 없다고 떠요”).',
      'answer':
          '본 앱은 Apple 건강 앱(Health)과 연동해 Apple Watch로 측정된 수면 기록을 불러옵니다. '
          'Apple Watch가 없거나 건강 앱의 수면 데이터 읽기 권한이 비활성화된 경우, 수면분석·수면차트 기능을 이용할 수 없습니다.\n'
          '• Apple Watch 보유가 필요합니다.\n'
          '• iPhone의 건강 앱에서 본 앱의 “수면” 데이터 읽기 권한을 허용해 주세요.\n'
          '• Apple Watch의 수면 추적이 활성화되어 있는지 확인해 주세요.\n'
          '그래도 보이지 않으면 iPhone/Watch 재부팅 또는 앱 재로그인을 시도해 주세요.',
    },
    {
      'question': '코알라와 대화 중 “졸려요”라고 말하면 어떤 사운드가 재생되나요?',
      'answer': '사용자가 마지막으로 추천받은 수면 사운드를 자동으로 재생합니다.',
    },
    {
